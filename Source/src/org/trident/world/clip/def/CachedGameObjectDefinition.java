package org.trident.world.clip.def;

import org.trident.world.clip.stream.ByteStreamExt;
import org.trident.world.clip.stream.MemoryArchive;
...
public final class CachedGameObjectDefinition {
	
	public static CachedGameObjectDefinition class46;
	...
	private static CachedGameObjectDefinition forId667(int id) {
		...
		CachedGameObjectDefinition object = cache[cacheIndex];
		/*Removing doors etc*/
		if(removedObject(id)) {
	...
	public static CachedGameObjectDefinition forId(int i) {
	...
	public static void init() {
		...
		cache = new CachedGameObjectDefinition[20];
		for (int k = 0; k < 20; k++) {
			cache[k] = new CachedGameObjectDefinition();
		}
	...
	public CachedGameObjectDefinition() {
		id = -1;
	}
	...
	public int anInt781;
	public static CachedGameObjectDefinition[] cache;
	public int anInt783;
