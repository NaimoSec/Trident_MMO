...
public enum Plants {
	GUAM(5291, 199, 4, 173, 170, 9, 5, SeedType.HERB, 11.0D, 12.5D, 5), 
	MARENTILL(5292, 201, 11, 173, 170, 14, 5, SeedType.HERB, 13.5D, 15.0D, 5), 
	TARROMIN(5293, 203, 18, 173, 170, 19, 5, SeedType.HERB, 16.0D, 18.0D, 5), 
	HARRALANDER(5294, 205, 25, 173, 170, 26, 5, SeedType.HERB, 21.5D, 24.0D, 5), 
	RANARR(5295, 207, 32, 173, 170, 32, 5, SeedType.HERB, 27.0D, 30.5D, 5),
	TOADFLAX(5296, 3050, 39, 173, 170, 36, 5, SeedType.HERB, 34.0D, 38.5D, 5), 
	IRIT(5297, 209, 46, 173, 170, 44, 5, SeedType.HERB, 43.0D, 48.5D, 5), 
	AVANTOE(5298, 211, 53, 173, 170, 50, 5,	SeedType.HERB, 54.5D, 61.5D, 5), 
	WERGALI(14870, 14836, 60, 173, 170, 46, 5, SeedType.HERB,	52.799999999999997D, 52.799999999999997D, 5),
	KWUARM(5299, 213, 68, 173, 170, 56, 5, SeedType.HERB, 69.0D,	78.0D, 5), 
	SNAPDRAGON(5300, 3052, 75, 173, 170, 62, 5, SeedType.HERB, 87.5D, 98.5D, 5), 
	CADANTINE(5301,		215, 82, 173, 170, 67, 5, SeedType.HERB, 106.5D, 120.0D, 5), 
	LANTADYME(5302, 2486, 89, 173, 170, 73, 5,	SeedType.HERB, 134.5D, 151.5D, 5), 
	DWARF_WEED(5303, 217, 96, 173, 170, 79, 5, SeedType.HERB, 170.5D,	192.0D, 5), 
	TORSTOL(5304, 219, 103, 173, 170, 85, 5, SeedType.HERB, 199.5D, 224.5D, 5),
