...
public class WoodcuttingData {
	...
	public static enum Trees {
		NORMAL(1, 340, 1511, new int[] { 1276, 1277, 1278, 1279, 1280, 1282, 1283, 1284, 1285, 1286, 1289, 1290, 1291, 1315, 1316, 1318, 1319, 1330, 1331, 1332, 1365, 1383, 1384, 3033, 3034, 3035, 3036, 3881, 3882, 3883, 5902, 5903, 5904 }, 4, false),
		ACHEY(1, 340, 2862, new int[] { 2023 }, 4, false),
		OAK(15, 502, 1521, new int[] { 1281, 3037 }, 5, true),
		WILLOW(30, 880, 1519, new int[] { 1308, 5551, 5552, 5553 }, 6, true),
		TEAK(35, 1200, 6333, new int[] { 9036 }, 7, true),
		DRAMEN(36, 1212, 771, new int[] { 1292 }, 7, true),
		MAPLE(45, 1600, 1517, new int[] { 1307, 4677 }, 7, true),
		MAHOGANY(50, 2100, 6332, new int[] { 9034 }, 7, true),
		YEW(60, 4200, 1515, new int[] { 1309 }, 8, true),
		MAGIC(75, 7990, 1513, new int[] { 1306 }, 9, true);
