...
public class Equipment extends ItemContainer {
	...
	private int[] itemDegradingCharges = new int[capacity()];
	
	public int[] getItemDegradationCharges() {
		return itemDegradingCharges;
	}
	...
	public boolean wearingTorva() {
		return getPlayer().getEquipment().getItems()[HEAD_SLOT].getId() == 13362 && getPlayer().getEquipment().getItems()[BODY_SLOT].getId() == 13358 && getPlayer().getEquipment().getItems()[LEG_SLOT].getId() == 13360;
	}
