...
public class PathFinder {
	...
	public static void findPath(GameCharacter gc, int destX, int destY, boolean moveNear,
		...
		try {
			...
			gc.getMovementQueue().reset(true);
			final int size = tail--;
			...
			CombatHandler.resetAttack(gc);
			gc.followCharacter(null);
			gc.getMovementQueue().stopMovement();
		}
	}
}
