public final class ItemDef {
	...
	public static ItemDef forID(int i) {
		...
		break;
		case 10942:
			itemDef.name = "Bronze Member Rank";
			itemDef.actions = new String[5];
			itemDef.actions[4] = "Drop";
			itemDef.actions[0] = "Claim";
			break;
		case 10934:
			itemDef.name = "Silver Member Rank";
			itemDef.actions = new String[5];
			itemDef.actions[4] = "Drop";
			itemDef.actions[0] = "Claim";
			break;
		case 10935:
			itemDef.name = "Gold Member Rank";
			itemDef.actions = new String[5];
			itemDef.actions[4] = "Drop";
			itemDef.actions[0] = "Claim";
			break;
		case 10943:
			itemDef.name = "Platinum Member Rank";
			itemDef.actions = new String[5];
			itemDef.actions[4] = "Drop";
			itemDef.actions[0] = "Claim";
			break;
		case 10944:
			itemDef.name = "Diamond Member Rank";
			itemDef.actions = new String[5];
			itemDef.actions[4] = "Drop";
			itemDef.actions[0] = "Claim";
			break;
...
*/
		...
		case 21083:
			...
			itemDef.description = "It's an Armadyl rune";
			itemDef.modelZoom = 811;
			itemDef.rotationY = 431;
			itemDef.rotationX = 1037;
			itemDef.modelOffsetY = 1;
			itemDef.modelOffset1 = 1;
		break;
		case 20674:
