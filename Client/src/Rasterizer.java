...
public final class Rasterizer extends DrawingArea {
	...
	} //ah totally forgot about this owner blade told me about it he has like old texture new texture togle
	
	//hyave you tried turning old texture on see if it renders then ? the defenders or? warrioirs guild walls
		                    ...
		                    if (src_alpha != 0 || force)
		                    {
		                        if (src_alpha != 0xff && color >= 0)
		                        {
		                            ...
		                            else
		                            {
		                                ...
		                                g = color>> 8 & 0xff;
		                                b = color & 0xff;
		                                r = light * r * 3 >> 9; if (r > 0xff) r = 0xff;
		                                g = light * g * 3 >> 9; if (g > 0xff) g = 0xff;
		                                b = light * b * 3 >> 9; if (b > 0xff) b = 0xff;
		                                src = r << 16 | g << 8 | b;
		                                //src = ((0xff00ff00 & (0xff00ff & src) * src_alpha 
