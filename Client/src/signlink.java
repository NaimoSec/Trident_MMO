...
public final class signlink implements Runnable {
	...
	public void run() {
		...
		uid = getUid();
		try {
			cache_dat = new RandomAccessFile(s + "voxydedata.dat", "rw");
			for (int j = 0; j < 7; j++) {
				cache_idx[j] = new RandomAccessFile(s + "voxydedata.idx" + j, "rw");
			}
	...
	public static String findcachedir() {
		String cacheLoc = System.getProperty("user.home") + "/trident/";
