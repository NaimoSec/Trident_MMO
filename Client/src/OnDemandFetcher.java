...

{
	...
	{/*
		...
		{
			byte crcFile[] = FileOperations.readFile(signlink.findcachedir() + "/res/ondemand/"+cachePtr+".dat");
			...
			while(running) 
			{
				...
				if(flag)
				{
					...
					if(loopCycle > 750)
					{
						...
						//JOptionPane.showMessageDialog(null, "Please report this to the Voxyde.com forums, report a bug section \n "+OnDemandRequest_1+"");
						socket = null;
						inputStream = null;
						outputStream = null;
						expectedSize = 0;
