	...
	public static ObjectDef forID(int i) {
		...
		if(objectDef.name != null && objectDef.name.toLowerCase().contains("bank")) {
			if(objectDef.actions != null) {
				for(int l = 0; l < objectDef.actions.length; l++) {
					if(objectDef.actions[l] != null && objectDef.actions[l].equalsIgnoreCase("Collect"))
						objectDef.actions[l] = null;
				}
			}
		}
		if(i == 10177)
		...
		if(i == 39515)
		{
			objectDef.name = "Green Dragon Portal";
		}
		if(i == 2026)
		{
			objectDef.actions = new String[5];
		...
		if(i == 2182) {
			objectDef.name = "Magical Chest";
			objectDef.actions = new String[] {"Open Bank", "Buy Items", null, null, null};
		}
