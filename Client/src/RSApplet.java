...
WindowListener {
	...
	void drawLoadingText(int percentage, String loadingText) {
		...
		graphics.drawString("Voxyde V"+Configuration.CLIENT_VERSION+" is loading.. ", 315, y - 8);
		graphics.drawString("Please let the Voxyde Cache load without interruption. ", 222, 315);
		graphics.drawString("This process may take a few minutes, ", 263, 330);
		graphics.drawString("thank you for your patience.", 285, 345);
	}
